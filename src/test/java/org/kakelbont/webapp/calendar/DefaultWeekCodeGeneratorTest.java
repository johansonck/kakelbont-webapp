...
public class DefaultWeekCodeGeneratorTest {
	...
	public void test() throws Exception {
		...
		XmlElement actual = new DefaultWeekCodeGenerator().generate(new GregorianCalendar(2011, Calendar.AUGUST, 10), null, null);
	...
	public void testEmptyDaysBefore() throws Exception {
		...
		XmlElement actual = new DefaultWeekCodeGenerator().generate(new GregorianCalendar(2011, Calendar.SEPTEMBER, 2), null, null);
	...
	public void testEmptyDaysBefore2() throws Exception {
		...
		XmlElement actual = new DefaultWeekCodeGenerator().generate(new GregorianCalendar(2011, Calendar.MAY, 1), null, null);
	...
	public void testEmptyDaysAfter() throws Exception {
		...
		XmlElement actual = new DefaultWeekCodeGenerator().generate(new GregorianCalendar(2011, Calendar.OCTOBER, 31), null, null);
	...
	public void testHolidays() throws Exception {
		...
		XmlElement actual = new DefaultWeekCodeGenerator().generate(
