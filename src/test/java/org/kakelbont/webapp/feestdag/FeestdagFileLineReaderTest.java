...
public class FeestdagFileLineReaderTest {

	@Test
	public void testShortLine() throws Exception {
		FeestdagFileLineReader reader = new FeestdagFileLineReader("/test-feestdagen-overzicht.txt");
		
		List<Feestdag> list = reader.readLine();
